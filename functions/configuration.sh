...
Prepare_config ()
{
	...
	LINGMO_SYS_BUILD_DISTRIBUTION="${LINGMO_SYS_BUILD_DISTRIBUTION:-testing}"
	...
	if [ "${LINGMO_SYS_BUILD_MODE}" = "debian" ]; then
		LINGMO_SYS_BUILD_MIRROR_BOOTSTRAP="${LINGMO_SYS_BUILD_MIRROR_BOOTSTRAP:-http://deb.debian.org/debian/}"
	...
	if [ "${LINGMO_SYS_BUILD_MODE}" = "debian" ]; then
		...
		LINGMO_SYS_BUILD_MIRROR_BINARY="${LINGMO_SYS_BUILD_MIRROR_BINARY:-http://deb.debian.org/debian/}"
